...
export const getDetailUser = async(id) => {
  try {
    ...
    console.error('Get Detail User:', error.response ? error.response.data : error.message);
    throw error;
  }
}
...
export const getAllUser = async() => {
  try {
    ...
    console.error('Get All User Error:', error.response ? error.response.data : error.message);
    throw error;
  }
};
