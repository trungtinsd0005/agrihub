  ...
  const handlePlaceOrder = async () => {
    ...
    if (selectedPayment === "momo") {
      try {
        ...
        if (paymentResponse.resultCode !== 0) {
          message.error(`Thanh toán thất bại: ${paymentResponse.message}`);
        }
      } catch (error) {
  ...
  const handleApplyVoucher = async () => {
    ...
    try {
      ...
      if (response.message === "Sử dụng voucher thành công!") {
        ...
        message.success(
          `Áp dụng mã giảm giá ${voucherCode} thành công!
          `
        );
      } else {
    ...
    <WrapperBgColorComponent>
      <Row gutter={18}>
        <Col span={16}>
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Select
                        ...
                        disabled={
                          !form.getFieldValue("district") || !wardData.length
                        }
                      >
                        {wardData.map((ward) => (
                  ...
                  <div key={product.id}>
                    <div className="cart_checkout__product">
                      ...
                      <div className="space-between__flex">
                        <span className="cart_checkout__product-name">
                          {product.name}
                        </span>
                        <div className="cart_checkout__price">
                          <span className="cart_checkout__product-price">
          ...
          <div className="sec-box">
            <div className="checkout__title">Hình thức thanh toán</div>
            <Radio.Group
          ...
          <div className="sec-box">
            <div className="discount-checkout">
              ...
              <div className="discount-checkout__notice">
                <span>
                  ** Mã giảm giá đơn hàng áp dụng cho giảm giá số tiền sản phẩm
                  trong đơn.
                </span>
                <span>
                  ** Mã giảm giá vận chuyển áp dụng cho giảm giá vận chuyển đơn
                  hàng.
                </span>
                <span>
                  ** Giá trị giảm giá nếu vượt quá giá trị đơn hàng hoặc giá trị
                  vận chuyển sẽ không trừ lẫn nhau.
                </span>
              </div>
            </div>
            <div className="sec-box">
              ...
              <Button
                className="checkout-order__button"
